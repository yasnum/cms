...
add_action('td_global_after', 'td_on_global_after_multipurpose_panel');
function td_on_global_after_multipurpose_panel() {
...
class td_api_multi_purpose {
	...
	static $typography_settings_list;
 	...
 	function __construct() {
	    ...
	    add_action( 'tdc_loaded', array($this, 'tdm_on_load_images' ) ); // hook used to load default images
...
//			}
    ...
    function get_shadow_group_params( $param_name, $shadow_title, $shadow_size, $shadow_offset_h, $shadow_offset_v, $group = '', $index_style = '' ) {
        $params = $this->group_params[ 'shadow' ];
...
//		);
    ...
    static function tdm_plugin_wpadmin_css() {
        wp_enqueue_style('td-plugin-multi-purpose', plugins_url('', __FILE__) . '/style-admin.css'); // backend css (admin_enqueue_scripts)
    }

    static function tdm_plugin_frontend_css() {
        wp_enqueue_style('td-plugin-multi-purpose', plugins_url('', __FILE__) . '/style.css'); // frontend css (wp_enqueue_scripts)
    }
	...
	function tdm_on_load_images() {

		$ref_path = plugin_dir_path( __FILE__ ) . 'images/';

		$image_settings = array(
			'tdm_pic_1' => 'thumb_01.jpg',
			'tdm_pic_2' => 'thumb_02.jpg',
            'tdm_pic_3' => 'thumb_03.jpg',
            'tdm_pic_4' => 'thumb_04.jpg',
            'tdm_pic_5' => 'thumb_05.jpg',
            'tdm_pic_6' => 'thumb_06.png',
            'tdm_pic_7' => 'thumb_07.jpg',
            'tdm_pic_8' => 'thumb_08.jpg',
            'tdm_pic_9' => 'thumb_09.jpg',
			//'tdm_pic_6' => 'text.png',
		);
	...
	static function tdm_get_image( $value ) {
		$attach_id = null;
		$attaches = get_posts( array(
			'post_type' => 'attachment',
		    'meta_key'   => 'tdm_pic',
            ...
            array(
                ...
                "params" =>
	                array_merge(
                        ...
                        $this->get_font_group_params( 'f_descr', true, 'Description text', 'Style' ),
                        array(
                            array(
                                "param_name" => "separator",
                                "type" => "text_separator",
            ...
            array(
                ...
                "params" =>
                    array_merge(
                        ...
                        $this->get_font_group_params( 'f_title1', true, 'Title 1 text', 'Style' ),
                        $this->get_font_group_params( 'f_title2', false, 'Title 2 text', 'Style' ),
                    ...
                    json_encode(
                        array(
                            array(
                                ...
                                'image1' => self::tdm_get_image( 'tdm_pic_3' ),
                                'image2' => self::tdm_get_image( 'tdm_pic_4' ),
        ...
        td_api_block::add('tdm_block_inline_text',
            array(
                ...
                "params" => array_merge(
                    ...
                    $this->get_font_group_params( 'f_descr', true, 'Description text' ),
                    $css_tabs_params
                )
            )
        );
        ...
        td_api_block::add('tdm_block_inline_image',
            array(
                ...
                "params" => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 0, 0, 0 ),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
                    ...
                    $this->get_font_group_params( 'f_caption', true, 'Caption text' ),
                    $css_tabs_params
                )
            )
        );
        ...
        td_api_block::add('tdm_block_client',
            array(
                ...
                "params" => array_merge(
                    ...
                    $this->get_font_group_params( 'f_title', true, 'Title text' ),
                    $css_tabs_params
                )
            )
        );
...
//                ),
        ...
        td_api_block::add('tdm_block_list',
            array(
                ...
                "params" => array_merge(
                    ...
                    $this->get_font_group_params( 'f_list', true, 'List text' ),
                    $css_tabs_params
                )
            )
        );
        ...
        td_api_block::add('tdm_block_food_menu',
            array(
                ...
                'name' => __( 'Food menu product', 'td_composer' ),
                "class" => "",
                "controls" => "full",
                "category" => 'Blocks',
                'tdc_category' => 'Multipurpose',
	...
	function register_styles() {
        ...
        td_api_style::add( 'tds_title3', array(
                ...
                'params' => array_merge( array(
                    ...
                    $this->get_font_group_params( 'f_title', true, 'Title text', 'Style' ),
                    $this->get_font_group_params( 'f_subtitle', false, 'Subtitle text', 'Style' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_social5', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 10, 0, 2, 'Style'),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
                    ...
                    $this->get_shadow_group_params('shadow_hover', 'Shadow hover', 16, 0, 2, 'Style')
                ),
            )
        );
        ...
        td_api_style::add( 'tds_team_member1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_font_group_params( 'f_title', true, 'Name text', 'Style' ),
                    $this->get_font_group_params( 'f_job_title', false, 'Job title text', 'Style' ),
                    $this->get_font_group_params( 'f_descr', false, 'Description text', 'Style' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_progress_bar1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_font_group_params( 'f_title', true, 'Title text' ),
                    $this->get_font_group_params( 'f_percentage', false, 'Percentage text' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_counter1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_font_group_params( 'f_value', true, 'Value text' ),
                    $this->get_font_group_params( 'f_title', false, 'Title text' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_pricing1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 0, 0, 8, 'Style'),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
                    ...
                    $this->get_font_group_params( 'f_price', true, 'Price text', 'Style' ),
                    $this->get_font_group_params( 'f_old_price', false, 'Old price text', 'Style' ),
                    $this->get_font_group_params( 'f_currency', false, 'Currency text', 'Style' ),
                    $this->get_font_group_params( 'f_old_currency', false, 'Old currency text', 'Style' ),
                    $this->get_font_group_params( 'f_period', false, 'Charging period text', 'Style' ),
                    $this->get_font_group_params( 'f_ribbon', false, 'Ribbon text', 'Style' ),
                    $this->get_font_group_params( 'f_descr', false, 'Description text', 'Style' ),
                    $this->get_font_group_params( 'f_features', false, 'Features text', 'Style' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_pricing3', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 25, 0, 8, 'Style'),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
        ...
        td_api_style::add( 'tds_food_menu1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_font_group_params( 'f_title', true, 'Title text', 'Style' ),
                    $this->get_font_group_params( 'f_price', false, 'Price text', 'Style' ),
                    $this->get_font_group_params( 'f_descr', false, 'Description text', 'Style' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_call_to_action1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 0, 0, 8),
                    $this->get_font_group_params( 'f_descr', true, 'Description text', 'Style' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_call_to_action2', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 25, 0, 8),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
        ...
        td_api_style::add( 'tds_testimonial1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_font_group_params( 'f_name', true, 'Name text' ),
                    $this->get_font_group_params( 'f_job_title', false, 'Job title text' ),
                    $this->get_font_group_params( 'f_descr', false, 'Description text' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_button1', array(
                ...
                'params' => array_merge( array(
                    ...
                    $this->get_font_group_params( 'f_btn_text', true, 'Button text', 'Style' )
                )
            )
        );
        ...
        td_api_style::add( 'tds_button3', array(
                ...
                'params' => array_merge(array(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 16, 0, 2),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
                    ...
                    $this->get_shadow_group_params('shadow_hover', 'Hover shadow', 26, 0, 2),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
        ...
        td_api_style::add( 'tds_button4', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 0, 0, 2),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
                    ...
                    $this->get_shadow_group_params('shadow_hover', 'Hover shadow', 0, 0, 2),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
        ...
        td_api_style::add( 'tds_icon1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow', 'Shadow', 0, 0, 0, 'Style' ),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "horizontal_separator",
                    ...
                    $this->get_shadow_group_params('shadow_hover', 'Hover shadow', 0, 0, 0, 'Style' ),
                    array(
                        array(
                            "param_name" => "separator",
                            "type" => "text_separator",
        ...
        td_api_style::add( 'tds_icon_box1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_font_group_params( 'f_descr', true, 'Descrption text' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_icon_box4', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_shadow_group_params('shadow_hover', 'Shadow hover', 0, 0, 0, 'Style'),
                    $this->get_font_group_params( 'f_descr', true, 'Descrption text', 'Style' )
                ),
            )
        );
        ...
        td_api_style::add( 'tds_title_over_image1', array(
                ...
                'params' => array_merge(
                    ...
                    $this->get_font_group_params( 'f_title', true, 'Title text' ),
                    $this->get_font_group_params( 'f_subtitle', false, 'Subtitle text' )
                ),
            )
        );
	}
